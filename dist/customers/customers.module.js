...
const validate_customers_middleware_1 = require("./middlewares/validate-customers.middleware");
const validate_customer_account_middleware_1 = require("./middlewares/validate-customer-account.middleware");
let CustomersModule = class CustomersModule {
    configure(consumer) {
        consumer.apply(validate_customers_middleware_1.ValidateCustomerMiddleware, validate_customer_account_middleware_1.ValidateCustomerAccountMiddleware, (req, res, next) => {
